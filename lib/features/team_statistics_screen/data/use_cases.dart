...
@riverpod
Future<TeamStatisticsModel> fetchStatistics(Ref ref) {
  // TODO(dariowskii): use real teamId
  return ref.read(teamStatisticsRepositoryProvider).getTeamStatistics();
}
...
@riverpod
Future<TeamSessionListModel> fetchTeamSessions(Ref ref) {
  // TODO(dariowskii): use real teamId
  return ref.read(teamStatisticsRepositoryProvider).getTeamSessions();
}
